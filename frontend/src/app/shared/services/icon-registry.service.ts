...
export class IconRegistryService {
  ...
  private registerDefaults() {
    ...
    this.addIcon('publish', ['M4 15h16', 'M12 21V7', 'm7 10-7-7-7 7', 'M5 7h14']);
    ...
    this.addIcon('eye', ['M1 12s4-7 11-7 11 7 11 7-4 7-11 7S1 12 1 12z', 'M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6z']);
    this.addIcon('phone', ['M22 16.92V21a2 2 0 0 1-2.18 2 19.86 19.86 0 0 1-8.63-3.07 19.58 19.58 0 0 1-6-6A19.86 19.86 0 0 1 1 4.18 2 2 0 0 1 3 2h3a2 2 0 0 1 2 1.72 12.8 12.8 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L7.9 9.41a16.12 16.12 0 0 0 6.69 6.69l0.77-.35a2 2 0 0 1 2.11.45 12.8 12.8 0 0 0 2.81.7A2 2 0 0 1 22 16.92z']);
    this.addIcon('mail', ['M4 6h16a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2z', 'm22 8-10 6L2 8']);

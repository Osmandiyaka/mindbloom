...
import { StudentDetailDrawerComponent } from './student-detail-drawer.component';
import { StudentGuardianModalComponent } from './student-guardian-modal.component';
...
@Component({
  ...
  template: `
    <div class="students-hub">
      ...
      <app-student-detail-drawer
        [open]="detailDrawerOpen()"
        [vm]="viewVm">
      </app-student-detail-drawer>

      <app-student-guardian-modal

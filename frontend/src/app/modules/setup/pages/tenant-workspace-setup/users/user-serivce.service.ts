...
export class UserSerivce {
    ...
    activeSchoolNames = signal<string[]>([]);
    ...
    setActiveSchoolNames(names: string[]): void {
        this.activeSchoolNames.set(names);
    }
    ...
    setUsersStepSkipped(value: boolean): void {
        this.usersStepSkipped.set(value);
    }
    ...
    private loadUsersFromApi(): void {
        this.api.get<ApiUser[]>('users').subscribe({
            next: users => {

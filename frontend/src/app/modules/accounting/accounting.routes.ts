...
export const ACCOUNTING_ROUTES: Routes = [
  ...
  {
    path: 'fee-reports',
    loadComponent: () => import('./pages/fee-reports/fee-reports.component').then(m => m.FeeReportsComponent)
  },
  {
    path: 'expenses',
  ...
  {
    path: 'bank-recon',
    loadComponent: () => import('./pages/bank-recon/bank-recon.component').then(m => m.BankReconComponent)
  },
  {
    path: 'reports',

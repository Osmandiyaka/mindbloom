...
@Component({
  ...
  styles: [
    ...
    `.bar{height:100%; display:flex; align-items:center; justify-content:center; color:#0f1320; font-weight:700; font-size:0.85rem;}`,
    `.bar.review{background:rgba(var(--color-warning-rgb,245,158,11),0.85);}`,
    `.bar.enrolled{background:rgba(var(--color-success-rgb,16,185,129),0.9);}`,
    `.bar.rejected{background:rgba(var(--color-error-rgb,239,68,68),0.85);}`,

...
@Component({
  ...
  styles: [
    ...
    `.btn{border:1px solid var(--color-border); border-radius:7px; padding:0.28rem 0.6rem; font-weight:600; cursor:pointer; background:var(--color-surface); color:var(--color-text-primary); line-height:1; font-size:0.92rem; height:32px; box-shadow:var(--shadow-sm, 0 1px 3px rgba(0,0,0,0.12));}`,
    ...
    `.btn.danger{background:color-mix(in srgb, var(--color-error) 12%, transparent); color:var(--color-error); border-color:color-mix(in srgb, var(--color-error) 40%, transparent);}`,
    ...
    `.pill.status.review{background:color-mix(in srgb, var(--color-warning) 14%, transparent); color:var(--color-warning);}`,
    `.pill.status.approved{background:color-mix(in srgb, var(--color-success) 15%, transparent); color:var(--color-success);}`,
    `.pill.status.rejected{background:color-mix(in srgb, var(--color-error) 15%, transparent); color:var(--color-error);}`,
    ...
    `.tab.active{background:linear-gradient(135deg, var(--color-primary-light), var(--color-primary)); color:var(--color-background, #0f172a); border:none;}`,

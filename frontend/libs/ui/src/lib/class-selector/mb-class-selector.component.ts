...
@Component({
    ...
    template: `
        <div class="mb-class-selector" #host [class.mb-class-selector--disabled]="disabled">
            <div
            ...
            <ng-template #overlayPanel>
                <div class="mb-class-selector__panel" role="listbox">
                    <mb-input
...
export class MbClassSelectorComponent implements OnDestroy {
    ...
    private attachOverlay(): void {
        ...
        element.className = 'mb-class-selector__overlay mb-popover-panel mb-popover-panel--above-modal';
